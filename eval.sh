export PYTHONPATH="./evaluation:/home/p20200470/miniconda3/envs/forte/bin/python"
...
CUDA_VISIBLE_DEVICES=1 /home/p20200470/miniconda3/envs/forte/bin/accelerate launch --config_file=./evaluation/pipeline/accelerate_configs/accelerate_config_fsdp.yaml \
